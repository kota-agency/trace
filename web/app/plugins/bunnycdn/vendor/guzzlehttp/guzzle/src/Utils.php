...
use Bunny_WP_Plugin\GuzzleHttp\Exception\InvalidArgumentException;
use Bunny_WP_Plugin\GuzzleHttp\Handler\CurlHandler;
use Bunny_WP_Plugin\GuzzleHttp\Handler\CurlMultiHandler;
use Bunny_WP_Plugin\GuzzleHttp\Handler\Proxy;
use Bunny_WP_Plugin\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \Bunny_WP_Plugin\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
