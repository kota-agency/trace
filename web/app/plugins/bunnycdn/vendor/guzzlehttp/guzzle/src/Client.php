...
use Bunny_WP_Plugin\GuzzleHttp\Cookie\CookieJar;
use Bunny_WP_Plugin\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \Bunny_WP_Plugin\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
