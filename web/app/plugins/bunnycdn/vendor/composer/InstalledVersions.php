 ...
 */
namespace Bunny_WP_Plugin\Composer;

use Bunny_WP_Plugin\Composer\Autoload\ClassLoader;
use Bunny_WP_Plugin\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Bunny_WP_Plugin\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
