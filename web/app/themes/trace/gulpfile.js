...
// Optimize Styles
function styles() {
  const plugins = [atImport(), autoprefixer({ browsers: ['last 2 versions'] }), cssnano()]
  return gulp
...
// Build for prod
const buildProd = gulp.series(clean, gulp.parallel(styles, scripts, scriptsVendor, images, fonts))
